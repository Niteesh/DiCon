...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <script src="${user_id}_files/ga.js" async=""></script><script src="${pageContext.request.contextPath}/static/js/core.js" async="" type="text/javascript" id="LR3"></script><script src="${user_id}_files/profiles.js" async="" type="text/javascript" id="LR2"></script><script>document.domain='twitter.com'</script>
  ...
  <div class="banner">
    <div class="banner-inside slow-warning">
      ...
      <span class="warning">Hmm, this seems to be taking a while. If problems persist, <a href="javascript:window.location.reload(true);">please reload</a> to try again.</span>
              ...
              <div class="container">
                ...
                <div class="pull-right">
                  <div class="well topbar-tweet-btn">
                    <button data-original-title="Compose new Tweet" id="global-new-tweet-button" type="button" class="btn btn-tweet js-global-new-tweet js-hover js-tooltip" data-placement="bottom" data-component-term="new_tweet_button">
    	...
    	<div class="content">
    	  <div class="account-group js-mini-current-user" data-user-id="612622708" data-screen-name="niteesh3k">
    	    <img class="avatar size32" src="${user_id}_files/Niteesh_Kumar_normal.png" alt="niteesh kumar" data-user-id="612622708">
    	    ...
    	    <small class="metadata">View my profile page</small>
              ...
              <li>
                ...
                <form class="dropdown-link-form signout-form" id="signout-form" action="/logout" method="POST">
                  <input value="534b1bd42ec027a09d024e9b698d9ad37d9171f2" name="authenticity_token" class="authenticity_token" type="hidden">
            ...
            <input data-focus="false" class="search-input" id="search-query" placeholder="Search" name="q" autocomplete="off" spellcheck="false" tabindex="-1" type="text">
      ...
      <div class="dropdown-inner js-typeahead-results">
        <ul class="typeahead-items saved-searches-list"></ul>    <ul style="display: none;" class="typeahead-items topics-list"></ul>    <div style="display: none;" class="typeahead-accounts js-typeahead-accounts">
  ...
  <div class="dashboard">
      ...
      <div class="tweet-content">
          ...
          <textarea dir="ltr" class="tweet-box" id="tweet-box-1343080785">@${user_id}</textarea><textarea style="display: none;" dir="ltr" class="tweet-box" name="status">@${user_id}</textarea>
      ...
      <div class="module profile-nav">
        <ul class="js-nav-links">
          <li class="active">
            <a class="list-link" href="https://twitter.com/${user_id}" data-nav="profile">Tweets<i class="chev-right"></i></a>
          </li>
          <li class="">
            <a class="list-link" href="https://twitter.com/#%21/${user_id}/following" data-nav="following">Following<i class="chev-right"></i></a>
          </li>
          <li class="">
            <a class="list-link" href="https://twitter.com/#%21/${user_id}/followers" data-nav="followers">Followers<i class="chev-right"></i></a>
          </li>
          <li class="">
            <a class="list-link" href="https://twitter.com/#%21/${user_id}/favorites" data-nav="favorites">Favorites<i class="chev-right"></i></a>
          </li>
          <li class="">
            <a class="list-link" href="https://twitter.com/${user_id}/lists" data-nav="all_lists">Lists<i class="chev-right"></i></a>
          </li>
          ...
          <a href="https://twitter.com/#%21/${user_id}/media/grid" class="list-link">
            ...
            <div class="media-row">
              <div class="media-row-content">
                    <span data-resolved-url-small="//instagr.am/p/NZHX79QhbG/media/?size=t" data-load-status="loaded" data-href="/#!/${user_id}/media/slideshow?url=http%3A%2F%2Finstagr.am%2Fp%2FNZHX79QhbG%2F" data-url="http://instagr.am/p/NZHX79QhbG/" class="media-thumbnail"><img style="position: absolute; height: 66px; width: 66px; left: 0px; top: 0px;" src="${user_id}_files/a_002.jpeg"></span>
            <span data-resolved-url-small="//instagr.am/p/NZGhjfwhaZ/media/?size=t" data-load-status="loaded" data-href="/#!/${user_id}/media/slideshow?url=http%3A%2F%2Finstagr.am%2Fp%2FNZGhjfwhaZ%2F" data-url="http://instagr.am/p/NZGhjfwhaZ/" class="media-thumbnail"><img style="position: absolute; height: 66px; width: 66px; left: 0px; top: 0px;" src="${user_id}_files/a_003.jpeg"></span>
            <span data-resolved-url-small="//instagr.am/p/NTNamhQhSq/media/?size=t" data-load-status="loaded" data-href="/#!/${user_id}/media/slideshow?url=http%3A%2F%2Finstagr.am%2Fp%2FNTNamhQhSq%2F" data-url="http://instagr.am/p/NTNamhQhSq/" class="media-thumbnail"><img style="position: absolute; height: 66px; width: 66px; left: 0px; top: 0px;" src="${user_id}_files/a.jpeg"></span>
            <span data-resolved-url-small="//instagr.am/p/NRcTT6QheA/media/?size=t" data-load-status="loaded" data-href="/#!/${user_id}/media/slideshow?url=http%3A%2F%2Finstagr.am%2Fp%2FNRcTT6QheA%2F" data-url="http://instagr.am/p/NRcTT6QheA/" class="media-thumbnail"><img style="position: absolute; height: 66px; width: 66px; left: 0px; top: 0px;" src="${user_id}_files/a_004.jpeg"></span>
            <span data-load-status="not-loaded" data-href="/#!/${user_id}/media/slideshow?url=http%3A%2F%2Finstagr.am%2Fp%2FNQ7CNIQhXN%2F" data-url="http://instagr.am/p/NQ7CNIQhXN/" class="media-thumbnail"></span>
            <span data-load-status="not-loaded" data-href="/#!/${user_id}/media/slideshow?url=http%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3DH9ZTP2k0DRc" data-url="http://www.youtube.com/watch?v=H9ZTP2k0DRc" class="media-thumbnail"></span>
            <span data-load-status="not-loaded" data-href="/#!/${user_id}/media/slideshow?url=http%3A%2F%2Fm.tmi.me%2Ftn6n5" data-url="http://m.tmi.me/tn6n5" class="media-thumbnail"></span>
            <span data-load-status="not-loaded" data-href="/#!/${user_id}/media/slideshow?url=http%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3DhrbKp5N74zE" data-url="http://www.youtube.com/watch?v=hrbKp5N74zE" class="media-thumbnail"></span>
            <span data-load-status="not-loaded" data-href="/#!/${user_id}/media/slideshow?url=http%3A%2F%2Flockerz.com%2Fs%2F223610427" data-url="http://lockerz.com/s/223610427" class="media-thumbnail"></span>
            <span data-load-status="not-loaded" data-href="/#!/${user_id}/media/slideshow?url=http%3A%2F%2Fyoutu.be%2FLj5_FhLaaQQ" data-url="http://youtu.be/Lj5_FhLaaQQ" class="media-thumbnail"></span>
            <span data-load-status="not-loaded" data-href="/#!/${user_id}/media/slideshow?url=http%3A%2F%2Flockerz.com%2Fs%2F220926344" data-url="http://lockerz.com/s/220926344" class="media-thumbnail"></span>
            <span data-load-status="not-loaded" data-href="/#!/${user_id}/media/slideshow?url=pic.twitter.com%2FEEb5kcvn" data-url="https://p.twimg.com/AwjxpXsCEAA-Yh2.jpg:thumb" data-resolved-url-small="https://p.twimg.com/AwjxpXsCEAA-Yh2.jpg:thumb" class="media-thumbnail"></span>
            <span data-load-status="not-loaded" data-href="/#!/${user_id}/media/slideshow?url=http%3A%2F%2Finstagr.am%2Fp%2FMbl0wbLVUU%2F" data-url="http://instagr.am/p/Mbl0wbLVUU/" class="media-thumbnail"></span>
            <span data-load-status="not-loaded" data-href="/#!/${user_id}/media/slideshow?url=http%3A%2F%2Flockerz.com%2Fs%2F220185150" data-url="http://lockerz.com/s/220185150" class="media-thumbnail"></span>
            <span data-load-status="not-loaded" data-href="/#!/${user_id}/media/slideshow?url=http%3A%2F%2Flockerz.com%2Fs%2F217734041" data-url="http://lockerz.com/s/217734041" class="media-thumbnail"></span>
            <span data-load-status="not-loaded" data-href="/#!/${user_id}/media/slideshow?url=http%3A%2F%2Finstagr.am%2Fp%2FL8G1j9rVSm%2F" data-url="http://instagr.am/p/L8G1j9rVSm/" class="media-thumbnail"></span>
            <span data-load-status="not-loaded" data-href="/#!/${user_id}/media/slideshow?url=http%3A%2F%2Finstagr.am%2Fp%2FLnyNAErVUK%2F" data-url="http://instagr.am/p/LnyNAErVUK/" class="media-thumbnail"></span>
            <span data-load-status="not-loaded" data-href="/#!/${user_id}/media/slideshow?url=http%3A%2F%2Finstagr.am%2Fp%2FLn4icErVXr%2F" data-url="http://instagr.am/p/Ln4icErVXr/" class="media-thumbnail"></span>
            <span data-load-status="not-loaded" data-href="/#!/${user_id}/media/slideshow?url=http%3A%2F%2Finstagr.am%2Fp%2FLn4U2MLVXh%2F" data-url="http://instagr.am/p/Ln4U2MLVXh/" class="media-thumbnail"></span>
            <span data-load-status="not-loaded" data-href="/#!/${user_id}/media/slideshow?url=http%3A%2F%2Finstagr.am%2Fp%2FLn5v8KSdNF%2F" data-url="http://instagr.am/p/Ln5v8KSdNF/" class="media-thumbnail"></span>
            <span data-load-status="not-loaded" data-href="/#!/${user_id}/media/slideshow?url=http%3A%2F%2Finstagr.am%2Fp%2FLlSqw7whUV%2F" data-url="http://instagr.am/p/LlSqw7whUV/" class="media-thumbnail"></span>
      </div>
            </div>
          </a>
        </li>    </ul>
        ...
        <div class="component" data-component-term="similar_user_recommendations">
          ...
          <div class="flex-module">
            <div style="opacity: 1;" class="dashboard-user-recommendations flex-module-inner" data-section-id="wtf">  <div class="js-account-summary account-summary js-actionable-user account-summary-small" data-user-id="57879889" data-feedback-token="2">
    <div class="content">
      <a class="account-group js-recommend-link js-user-profile-link user-thumb" href="https://twitter.com/Minissha_Lamba" data-user-id="57879889">
        
        <img class="avatar js-action-profile-avatar size32" src="${user_id}_files/mini_profile_pic_normal.jpg" alt="Minissha Lamba">
    ...
    <div class="js-account-summary account-summary js-actionable-user account-summary-small" data-user-id="102594253" data-feedback-token="2">
    <div class="content">
      <a class="account-group js-recommend-link js-user-profile-link user-thumb" href="https://twitter.com/mbhandarkar268" data-user-id="102594253">
        
        <img class="avatar js-action-profile-avatar size32" src="${user_id}_files/mbhandarkar268_normal.jpg" alt="Madhur Bhandarkar">
    ...
    <div class="js-account-summary account-summary js-actionable-user account-summary-small" data-user-id="125095065" data-feedback-token="1">
    <div class="content">
      <a class="account-group js-recommend-link js-user-profile-link user-thumb" href="https://twitter.com/rohiniyer" data-user-id="125095065">
        
        <img class="avatar js-action-profile-avatar size32" src="${user_id}_files/Ro.jpg" alt="rohini iyer">
        ...
        <div class="twttr-dialog-body clearfix">
          <div class="dm-dialog-content">
            <div class="dm-to">
              ...
              <img class="avatar size24 selected-profile" src="${user_id}_files/default_profile_6_mini.png" data-default-img="https://si0.twimg.com/sticky/default_profile_images/default_profile_6_mini.png">
              <ul style="display: none;" class="dropdown-menu autocomplete-results">
            <li class="dropdown-link dropdown-account template-row autocomplete-item">
              <img class="avatar size24" width="24" height="24">
              <strong class="fullname"></strong>
      ...
      <div class="modal-body">
        <div class="modal-inner">
          <form class="goto-user-form">
            <input class="username-input" placeholder="Start typing a name to jump to a profile" type="text">
            <ul style="display: none;" class="dropdown-menu autocomplete-results">
              <li class="dropdown-link dropdown-account template-row autocomplete-item">
                <img class="avatar size24" width="24" height="24">
                <strong class="fullname"></strong>
...
<div id="keyboard-shortcut-dialog" class="modal-container">
  ...
  </div>  <div id="list-create-dialog" class="modal-container">
    <div class="close-modal-background-target"></div>
      ...
      <div class="modal-content">
        ...
        <div class="list-editor">
          ...
          <div class="list-editor-save">
            <div class="button btn btn-primary update-list-button disabled" data-list-id="50406360">Save list</div>
          </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button id="confirm_dialog_submit_button" class="btn primary-btn modal-submit"></button>
            ...
            <script src="${user_id}_files/prereqs.js"></script>
        <script>
